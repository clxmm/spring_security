...
import org.clxmm.springsecurity02.config.security.filter.AdminAuthenticationProcessingFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // 自定义过滤器认证用户名密码
        http.addFilterAfter(adminAuthenticationProcessingFilter, UsernamePasswordAuthenticationFilter.class);
    }
